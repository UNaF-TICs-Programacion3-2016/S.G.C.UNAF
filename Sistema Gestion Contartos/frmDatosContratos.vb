...
Public Class frmDatosContratos
    ...
    Private Sub btnimprimircontrato_Click(sender As Object, e As EventArgs) Handles btnimprimircontrato.Click
        ...
        MsgBox("El DOCUMENTO se guardará en : E:\Dario\Escritorio\S.G.C.Unaf\" & txtapellido.Text + txtasignatura.Text + txtdni.Text + DateTimePicker8.Text & "CONTRATO.docx")
        FileCopy("E:\Dario\Escritorio\S.G.C.Unaf\CONTRATO MODELO.docx", "E:\Dario\Escritorio\S.G.C.Unaf\" & txtapellido.Text + txtasignatura.Text + txtdni.Text & "CONTRATO.docx")
        Documento = MSWord.Documents.Open("E:\Dario\Escritorio\S.G.C.Unaf\" & txtapellido.Text + txtasignatura.Text + txtdni.Text & "CONTRATO.docx")
