...
Public Class frmDatosDictamenes
    ...
    Private Sub btnguardardictamen_Click(sender As Object, e As EventArgs) Handles btnguardardictamen.Click
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        FileCopy("E:\Dario\Escritorio\S.G.C.Unaf\DICTAMEN MODELO.docx", "E:\Dario\Escritorio\S.G.C.Unaf\" & txtapellido.Text + txtasignatura.Text + txtdni.Text + DateTimePicker8.Text & "DICTAMEN.docx")
        Documento = MSWord.Documents.Open("E:\Dario\Escritorio\S.G.C.Unaf\" & txtapellido.Text + txtasignatura.Text + txtdni.Text + DateTimePicker8.Text & "DICTAMEN.docx")
